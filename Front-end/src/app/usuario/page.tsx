    ...
    return (
        <>
            ...
            <Box sx={{ mt: 5, width: "90%", ml: "5%" }}>
                <Paper elevation={3} sx={{ p: 1, display: 'flex', justifyContent: "space-between", borderRadius: 3 }}>
                    <Typography variant="h6" >Nome: {user.nome}</Typography>
                    <IconButton aria-label="edit" color='warning' onClick={() => setOpenNome(true)}>
                        <EditIcon />
                    </IconButton>
                </Paper>
                <Paper elevation={3} sx={{ p: 1, mt: 2, display: 'flex', justifyContent: "space-between", borderRadius: 3 }}>
